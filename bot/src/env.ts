...
export const env = {
  ...
  SUPABASE_STORAGE_BUCKET: process.env.SUPABASE_STORAGE_BUCKET || 'sticker-assets',
  SUPABASE_STORAGE_SIGNED_TTL_SECONDS: parseInt(process.env.SUPABASE_STORAGE_SIGNED_TTL_SECONDS || '1800', 10),
